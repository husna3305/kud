...
class UploadHandler
{
    ...
    protected function handle_file_upload($uploaded_file, $name, $size, $type, $error,
        ...
        if ($this->validate($uploaded_file, $file, $error, $index)) {
            ...
            $this->set_additional_file_properties($file);
            $max_product_id = (int)$_POST['max_product_id'][$index];
            $user_id = (int)$_POST['user_id'][$index];

            if (!$_POST['radio_check'][$index]) {
                $_POST['radio_check'][$index] = 0;
                $radio = 0;
            }else{
                $radio=1;
            }
            $data_product[1] = array(
                        'filename' => $file->name,
            ...
            $this->ci->Product_model->create_product_attachment($data_product);
        }
