                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="<?php echo active_link_controller('dashboard')?>">
                            <a href="<?php echo site_url('admin/dashboard'); ?>">
                                <i class="fa fa-tachometer-alt"></i> <span><?php echo lang('menu_dashboard'); ?></span>
                            </a>
                        </li>
                        ...
                        <li class="treeview <?=active_link_controller('users')?>">
                            ...
                            <ul class="treeview-menu">
                                <li class="<?=active_link_function('users')?>"><a href="<?php echo site_url('admin/users'); ?>"><?php echo lang('menu_users'); ?></a></li>
                        ...
                        <li class="treeview <?=active_link_controller('prefs')?>">
                            ...
                            <ul class="treeview-menu">
                                ...
                                <li class="<?=active_link_function('interfaces')?>"><a href="<?php echo site_url('admin/prefs/interfaces/public'); ?>"><?php echo lang('menu_interfaces'); ?></a></li>
                            </ul>
                        </li>
                        <li class="header text-uppercase"><?php echo lang('menu_product'); ?></li>
                        <li class="<?=active_link_controller('files')?>">
                            <a href="<?php echo site_url('admin/files'); ?>">
                                <i class="fa fa-boxes"></i> <span><?php echo lang('menu_product_list'); ?></span>
                            </a>
                        </li>
                    </ul>
                </section>
