...
?>
            <header class="main-header">
                <a href="<?php echo site_url('admin/dashboard'); ?>" class="logo">
                    ...
                    <span class="logo-lg"><?php echo $kud->nama_kud ?></span>
                </a>
...
<?php if ($admin_prefs['user_menu'] == TRUE): ?>
                            ...
                            <li class="dropdown user user-menu">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                    <img src="<?php echo base_url('assets/img/profile/'); ?><?php echo $this->ion_auth->user()->row()->picture_name ?>" class="img-circle" alt="User Image" width="23px">&nbsp;&nbsp;&nbsp;
                                    <span class="hidden-xs"><?php echo $user_login['firstname']; ?>&nbsp;<?php echo $user_login['lastname']; ?></span>
                                </a>
                                <ul class="dropdown-menu">
                                    <li class="user-header">
                                        <img src="<?php echo base_url('assets/img/profile/'); ?><?php echo $this->ion_auth->user()->row()->picture_name ?>" class="img-circle" alt="User Image">
                                        <p><?php echo $user_login['firstname'].$user_login['lastname']; ?> <small>E-Mail : <?php echo $user_login['email']; ?></small></p>
                                    </li>
                                    <!--
                                    <li class="user-body">
                                        <div class="row">
                                ...
                                -->
                                    <li class="user-footer">
                                        <div class="pull-left">
                                            <a href="<?php echo site_url('admin/users/profile/'.$user_login['id']); ?>" class="btn btn-default btn-flat">Profil</a>
                                        </div>
                                        <div class="pull-right">
                                            <a href="<?php echo site_url('auth/logout/admin'); ?>" class="btn btn-default btn-flat">Keluar</a>
                                        </div>
                                    </li>
                                </ul>
                            </li>
