					...
					<div class="box-header with-border">
						...
						<div class="row">
							...
							<div class="col-md-6" style="text-align: right;">
									<?php if ($inserted=='y'): ?>
									<h3 class="box-title"><?php echo anchor('admin/belanjabarang', '<i class="fa fa-plus"></i> &nbsp;&nbsp;Tambah', array('class' => 'btn btn-block btn-primary btn-')); ?></h3>
								<?php endif ?>
							</div>
						</div>
					</div>
					...
					<div class="box-body">
						<div class="form-horizontal">
							<div class="form-group">
								<label for="link" class="col-sm-1 control-label" style="text-align:left"><b style="text-align:right;">Periode :</b></label>
								<div class="col-sm-2">
									<input type="text" name="tanggal" class="form-control tanggal datepicker" readonly="" id="periode_mulai">
									<label class="control-label" id="tanggal_error" style="color:#a94442;display:none; text-align: left;"><i class="fa fa-ban"></i> Silahkan tentukan tanggal mulai periode</label>
								</div>
								<label for="link" class="col-sm-1 control-label" style="text-align:left"><b style="text-align:right;">&nbsp;&nbsp;Hingga</b></label>
								<div class="col-sm-2">
                ...
                <tbody>
                	<?php foreach ($transaksi_header as $th): ?>
                		<tr>
                			...
                			<td><a href="<?php echo site_url('admin/belanjabarang/sukses/'.$th->id_transaksi_belanja) ?>"><?php echo $th->id_transaksi_belanja ?></a></td>
