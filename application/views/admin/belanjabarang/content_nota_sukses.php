<div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>
        Nota Belanja
        <small>#<?php echo $transaksi_header->id_transaksi_belanja ?></small>
      </h1>
      <ol class="breadcrumb">
    ...
    <section class="invoice">
      ...
      <div class="row">
        <div class="col-xs-12">
          <h2 class="page-header">
            <i class="fa fa-archive"></i> Nota Belanja
      ...
      <div class="row invoice-info">
        ...
        <div class="col-sm-6 invoice-col">
          Data Suplier
          <address>
            <strong><?php echo $transaksi_header->nama_suplier ?></strong><br>
        ...
        <div class="col-sm-4 invoice-col col-sm-offset-2">
          <b>#<?php echo $transaksi_header->id_transaksi_belanja ?></b><br>
          <br>
          ...
          <table class="table table-striped">
            ...
            <?php $qty = 0; $subtotal=0;$total=0; foreach ($transaksi_detail as $td): ?>
              <tr>
                ...
                <td>Rp. <?php echo $this->cart->format_number($td->harga_beli) ?></td>
                <td>Rp. <?php echo $this->cart->format_number($td->harga_jual_tunai) ?></td>
                <td>Rp. <?php echo $this->cart->format_number($td->harga_jual_angsur) ?></td>
              </tr>
              <?php $subtotal = $td->qty*$td->harga_beli ?>
...
$('#btn_daftartransaksi').click(function(){
  window.location = "<?php echo site_url('admin/belanjabarang/daftartransaksi') ?>";
})
</script>