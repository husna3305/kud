	...
	<div class="row">
		<div class="col-md-12">
            ...
            <table id="data_table" class="table table-bordered table-striped table-hover">
                ...
                <tbody>
                	<?php $no=1; foreach ($bysuplier as $by_sp): ?>
                		<tr>
                			<td style="text-align: center;"><?php echo $no ?>.</td>
                			<td><a href="<?php echo site_url('admin/belanjabarang/bysuplierdetail/'.$by_sp->suplier) ?>"><?php echo $by_sp->nama_suplier ?></a></td>
                			<td align="center"><?php echo $this->cart->format_number($by_sp->jml_transaksi) ?></td>
                		</tr>
                	<?php $no++; endforeach ?>
                </tbody>
            </table>
