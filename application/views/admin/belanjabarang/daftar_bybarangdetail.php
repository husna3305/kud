		...
		<div class="col-md-12">
			<div class="box">
				<div class="box-header with-border">
					<div class="row">
						<div class="col-md-6">
							<a href="<?php echo site_url('admin/belanjabarang/bybarang') ?>" class="btn btn-default"><i class="fa fa-chevron-circle-left"></i>&nbsp;&nbsp;Kembali</a>
...
<script type="text/javascript">
	...
	e.preventDefault();
    $("#printf").attr("src", '<?php echo site_url('admin/belanjabarang/bybarangdetail_cetak/'.$this->uri->segment(4)) ?>/'+tgl_mulai+'/'+tgl_selesai);
...
<script>
    $(document).ready(function(){
    	...
    	//$("#printf").attr("src", "<?php echo site_url('admin/belanjabarang/bybarangdetail_cetak/'.$this->uri->segment(4)) ?>");
