			...
			<div class="content-wrapper">
				...
				<section class="content">
								...
								<div class="box-body" style="padding-left:30px;">
									<?php echo form_open_multipart(current_url(), array('class' => 'form-horizontal', 'id' => 'form-create_user')); ?>
										<div class="form-group " >
											...
											<div class="col-sm-3 ">
												<input type="text" name="name" value="<?php echo $one_brand->name ?>" id="name" class="form-control"/>
											</div>
											<div class="col-sm-6">
										...
										<div class="form-group">
											...
											<div class="col-sm-7 " >
												<textarea class="textarea" name="description" placeholder="Place some text here"
						  						style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"><?php echo $one_brand->description ?></textarea>
											</div>
											<div class="col-sm-2">
												<?php if (validation_errors()) { ?>
                    ...
                    <div class="form-group">
											...
											<div class="col-sm-5">
                        <div class="form-group">
                            <div id="image_preview"><img id="previewing" src="<?php echo base_url('upload/brand/'.$one_brand->logo_filename); ?>" width="150px"/></br></br></div>
                      <!--
                		  <button type="button" class="btn btn-primary" onclick="addNew()">Add new ImagerJs</button>
                		</div>
                		<div class="form-group" id="imagers"> !-->
                            <input type="hidden" name="filename_old" value="<?php echo $one_brand->logo_filename ?>">
	                		       <input class="btn btn-primary" type="file" name="file_brand" id="file" value="<?php echo $one_brand->logo_filename ?>" />
                		  </div>
											</div>
											<div class="col-sm-4">
												<?php if (validation_errors()) { ?>
										...
										<div class="form-group">
											...
											<div class="col-sm-2">
												<input type="text" name="order" value="<?php echo $one_brand->order ?>" id="order" class="form-control"/>
											</div>
											<div class="col-sm-4">
												<?php if (validation_errors()) { ?>
												<i style="color:red;margin-bottom:0px;"><?php echo form_error('order') ?></i>
										...
										<div class="form-group">
											...
											<div class="col-sm-9">
                        <input type="checkbox" <?php if($one_brand->active==1){echo "checked"; }?> id="active" name="active" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak">
...
// Function to preview image
  $(function() {
      ...
      {
      $('#previewing').attr('src','<?php echo $one_brand->logo_filename ?>');
