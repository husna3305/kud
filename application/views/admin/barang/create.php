					...
					<div class="box-body" style="padding-left:30px;">
							<div class="form-group" >
								<label for="name" class="col-sm-4 control-label" style="text-align:left">
									...
									<i style="font-size:12px;">Tulis nama barang yang akan ditambah</i>                
								</label>
								<div class="col-sm-5">
									<input type="text" name="nama_barang" id="nama_barang" value="<?php echo set_value('name') ?>" id="name" class="form-control input-char-count " maxlength="60"/>
							...
							<div class="form-group">
								<label for="link" class="col-sm-4 control-label" style="text-align:left">
									<b style="text-align:right;">Pilih Kategori Barang</b> <br />
									<i style="font-size:12px;">Pilih kategori untuk barang yang akan ditambah</i>                          
								</label>
								<div class="col-sm-4" >
								...
								<div class="col-sm-2">
									<button type="button" class="btn btn-primary" data-toggle="modal" data-target=".modal_cari-kategori"><i class="fa fa-search"></i></button>
								</div>
							</div>
							<div class="form-group">
								<label for="aktif" class="col-sm-4 control-label" style="text-align:left">
									<b style="text-align:right;">Status Aktif Barang</b> <br />
