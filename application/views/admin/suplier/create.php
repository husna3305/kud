			...
			<div class="col-md-12">
				 <div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Form Tambah Data Suplier</h3>
					</div>
					...
					<div class="box-body" style="padding-left:30px;">
							<div class="form-group" >
								<label for="name" class="col-sm-4 control-label" style="text-align:left">
									...
									<i style="font-size:12px;">Tulis nama suplier yang akan ditambah</i>                
								</label>
								<div class="col-sm-5">
									<input type="text" name="nama_suplier" id="nama_suplier" value="<?php echo set_value('name') ?>" id="name" class="form-control input-char-count " maxlength="60"/>
							...
							<div class="form-group" >
								<label for="name" class="col-sm-4 control-label" style="text-align:left">
									...
									<i style="font-size:12px;">Tulis alamat suplier yang akan ditambah</i>                
								</label>
								<div class="col-sm-8">
							...
							<div class="form-group" >
								<label for="name" class="col-sm-4 control-label" style="text-align:left">
									...
									<i style="font-size:12px;">Tulis nomor telepon atau nomor handphone suplier yang akan ditambah</i>                
								</label>
								<div class="col-sm-2">
