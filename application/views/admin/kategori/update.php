			...
			<div class="col-md-12">
				 <div class="box">
					<div class="box-header with-border">
						<h3 class="box-title">Form Update Kategori Barang</h3>
					</div>
					<?php echo form_open(current_url(), array('class' => 'form-horizontal form_update_kategori', 'id' => 'form_update_kategori', 'name' =>'frm')); ?>
					...
					<div class="box-body" style="padding-left:30px;">
							...
							<div class="form-group" >
								<label for="name" class="col-sm-4 control-label" style="text-align:left">
									...
									<i style="font-size:12px;">Tulis nama kategori barang yang akan diubah</i>                
								</label>
								<div class="col-sm-4">
									<input type="text" name="nama_kategori_baru" id="nama_kategori_baru" value="<?php echo $kategori->nama_kategori ?>" id="name" class="form-control input-char-count " maxlength="40"/>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="checkbox" id="check_parent_id" name="check_parent_id" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak" onchange="do_check_parent_id(this)" <?php if ($kategori->parent_id==0): ?>
										checked
									<?php endif ?> >
								</div>
							</div>
							...
							<div id="parent_id_select">
								<div class="form-group">
									...
									<div class="col-sm-4" >
										<input type="text" name="nama_kategori" class="form-control" readonly="" id="nama_kategori" value="<?php echo $kategori->parent_kategori ?>">
										...
										<input type="hidden" name="parent_id" id="id_kategori" value="<?php echo $kategori->parent_id ?>">
									</div>
							...
							<div class="form-group">
								...
								<div class="col-sm-8">
									<input type="checkbox" id="aktif" name="aktif" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak" <?php if ($kategori->aktif==1): ?>
										checked
									<?php endif ?>>
								</div>
							</div>
    ...
    // Submit Data
	    $('#btn_submit').click(function(){
			...
			if (!!nama_kategori_baru & cek_root_kategori == 1) {
	    		 document.getElementById('form_update_kategori').submit();
			}
