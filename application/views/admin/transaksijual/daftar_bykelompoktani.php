			 ...
			 <div class="box" >
				<div class="nav-tabs-custom">
					...
					<div class="box-header with-border">
						<div class="row">
						<h4 style="text-align: center;">Daftar Transaksi Penjualan Barang Berdasarkan Kelompok Tani</h4>
            ...
            <table id="data_table" class="table table-bordered table-striped table-hover">
                <thead style="font-weight: bold;font-size: 16px;background-color: #5ca1c7;color: white;">
                    <tr>      
                        ...
                        <th style="text-align: center;">Nama Kelompok Tani</th>  
                        <th style="text-align: center; width: 17%">Jumlah Transaksi</th>
                    </tr>
                </thead>
                <tbody>
                	<?php $no=1; foreach ($bykelompoktani as $by_kt): ?>
                		<tr>
                			<td style="text-align: center;"><?php echo $no ?>.</td>
                			<td><a href="<?php echo site_url('admin/transaksijual/bykelompoktanidetail/'.$by_kt->kelompok_tani) ?>"><?php echo $by_kt->nama_kelompok_tani ?></a></td>
                			<td align="center"><?php echo $this->cart->format_number($by_kt->jml_transaksi) ?></td>
                		</tr>
                	<?php $no++; endforeach ?>
                </tbody>
            </table>
