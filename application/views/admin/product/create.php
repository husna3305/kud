...
<!-- ============================= Informasi Produk ========================= !-->
               <div class="box">
                    ...
                    <div class="form-group">
											...
											<div class="col-sm-7" >
												<input type="text" name="video_product" value="" class="form-control" id="video_product">
											</div>
										</div>
...
$('#video_product').keyup(function(){
  var url = $('#video_product').val();
  ...
  var videoID = match;//working 

  $.getJSON('http://gdata.youtube.com/feeds/api/videos/'+videoID+'?v=2&alt=jsonc',function(data,status,xhr){}).error(function() { swal("Link Video Tidak Ditemukan"); })
});
   ...
   $('#btn-combine-insert').click(function(){
    ...
    $('#btn_submitproduct').click(function(){
        ...
        $.ajax({
            ...
            cache:false,
            success:function(result){
              //Get MaxID From New Input Product 
              var max_product_id = result;
              $("input[name='max_product_id[]']").val(max_product_id);
