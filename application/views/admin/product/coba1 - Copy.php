...
<!-- Generic page styles -->
<link rel="stylesheet" href="<?php echo base_url('assets/plugins/jquery-upload/css/style.css')?>">
...
<script src="<?php echo base_url('assets/plugins/jquery-upload/js/jquery.min.js')?>"></script>
<!-- The jQuery UI widget factory, can be omitted if jQuery UI is already included -->
<script src="<?php echo base_url('assets/plugins/jquery-upload/js/vendor/jquery.ui.widget.js')?>"></script>
...
<script src="<?php echo base_url('assets/plugins/jquery-cookies/jquery.cookie.js')?>"></script>
...
$(function () {
    ...
    $('#fileupload').fileupload({
        ...
        url: 'http://localhost/project-tanahabang/admin/product/upload_coba'
    });
    // Load existing files:
