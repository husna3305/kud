                                ...
                                <div class="box-body" style="padding-left:30px;">
                                    <?php echo form_open(current_url(), array('class' => 'form-horizontal', 'id' => 'form-create_user')); ?>
                                        ...
                                        <div class="form-group " >
                                            ...
                                            <div class="col-sm-3 ">
                                                <input type="hidden" name="menu_id" value="<?php echo $id_encode?>"/>
                                                <input type="text" name="name" value="<?php echo $one_menu->name ?>" id="name" class="form-control"/>                                                
                                            </div>
                                            <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5 " >
                                                <input type="text" name="link" value="<?php echo $one_menu->link ?>" id="link" class="form-control"/>
                                            </div>
                                            <div class="col-sm-4">
                                                <?php if (validation_errors()) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" id="is_parent" <?php if($one_menu->is_parent == 1){echo "checked"; } ?> name="is_parent" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak">
                                            </div>
                                        </div>
                                            ...
                                            <div class="col-sm-4 " >
                                                <select name="parent_id" class="form-control">
                                                    ...
                                                    <?php foreach( $menus_parent as $mp ) { ?>
                                                        <option value="<?php echo $mp->menu_id ?>" <?php if($mp->menu_id == $one_menu->parent_id){echo "selected"; }?> ><?php echo $mp->name ?></option>
                                                    <?php } ?>
                                                </select>
                                            </div>
                                            <div class="col-sm-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-5">
                                                <input type="checkbox" id="is_dropdown" <?php if($one_menu->is_dropdown == 1){echo "checked"; } ?> name="is_dropdown" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak">
                                            </div>
                                            <div class="col-sm-4">
                                                <?php if (validation_errors()) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" id="is_menu_header" <?php if($one_menu->is_menu_header == 1){echo "checked"; } ?> name="is_menu_header" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-4">
                                                <select name="menu_header_id" class="form-control">
                                                    <option value="0" >--Pilih Header Menu--</option>
                                                    <?php foreach( $menus_header as $mh ) { ?>
                                                        <option value="<?php echo $mh->menu_id ?>" <?php if($mh->menu_id == $one_menu->menu_header_id){echo "selected"; }?>><?php echo $mh->name ?></option>
                                                    <?php } ?>
                                                    </select>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-3">
                                                <input type="text" name="fa_icon" value="<?php echo $one_menu->fa_icon ?>" id="fa_icon" class="form-control"/>
                                            </div>
                                            <div class="col-sm-4">
                                                <?php if (validation_errors()) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-2">
                                                <input type="text" name="order" value="<?php echo $one_menu->order ?>" id="order" class="form-control"/>
                                            </div>
                                            <div class="col-sm-4">
                                                <?php if (validation_errors()) { ?>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-9">
                                                <input type="checkbox" id="active" <?php if($one_menu->active == 1){echo "checked"; } ?> name="active" data-toggle="toggle" data-width="70" data-height="33" data-on="Ya" data-off="Tidak">
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="col-sm-offset-3 col-sm-9">
                                                <div class="btn-group">
                                                    <?php echo form_button(array('name' => 'submit','value' => 'update','type' => 'submit', 'class' => 'btn btn-primary btn-flat', 'content' => lang('actions_submit'))); ?>
